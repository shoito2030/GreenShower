...
public class JobCsvRequestRepository {
	...
	/** CSV出力用SQL */
	private static final String SQL_SELECT_CSV = "SELECT * FROM JOB_HUNTING JH,REQUESTS REQ, REPORTS REP, USERS U WHERE JH.APPLY_ID = REQ.APPLY_ID AND JH.APPLY_ID = REP.APPLY_ID AND JH.APPLICANT_ID = U.USER_ID;";
