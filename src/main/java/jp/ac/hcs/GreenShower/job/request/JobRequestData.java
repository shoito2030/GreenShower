...
public class JobRequestData extends JobHuntingData{
	 ...
	 * 活動開始日時
	 */
	private LocalDateTime date_activity_from;
	
	/**
	 * 活動終了日時
	 */
	private LocalDateTime date_activity_to;
	 ...
	 * 欠席開始日時
	 */
	private LocalDateTime date_absence_from;
	
	/**
	 * 欠席終了日時
	 */
	private LocalDateTime date_absence_to;
	
	/**
	 * 早退日時
	 */
	private LocalDateTime leave_early_date;
