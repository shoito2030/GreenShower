...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String USER_SQL = "SELECT user_id, encrypted_password as password, enabled FROM users WHERE user_id = ?";
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/css/**").permitAll() // cssへアクセス許可
				...
				.antMatchers("/user/**").hasAnyAuthority("TEACHER", "STAFF")
