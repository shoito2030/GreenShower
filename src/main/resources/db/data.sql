...
/* reportのデータ */
INSERT INTO report (report_id, user_id, classroom, class_number, name, course_code, company_name, company_name_kana, datetime, place, entry_section, venue_section, test_section, test_summary, result_notification, aptitude_test_detail, interview_detail, interview_number, interviewer_number, interviewer_position, interview_time, question_contents, report_status, registered_date, request_date, registered_user_id, remarks)
VALUES('1', 'isida@xxx.co.jp', 'S3A1', '01', '石田悠介', )